...
GH_REPO="https://github.com/mikf/gallery-dl"
GH_RELEASES="https://api.github.com/repos/mikf/gallery-dl/releases"
TOOL_NAME="gallery-dl"
TOOL_TEST="gallery-dl --help"
...
download_release() {
  ...
  local url
  url="${GH_REPO}/releases/download/v${version}/gallery-dl.bin"
...
install_version() {
  ...
  ( 
    ...
    install -m 755 "${ASDF_DOWNLOAD_PATH}/${TOOL_NAME}" "$install_path" || fail "Installation failed"
